...
import { User, Monitor, Tag, ChevronDown, Activity } from 'lucide-react';

export default function TicketSidebar() {
  return (
    <div className="space-y-4 font-sans">
      <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Gestion del Ticket</h3>
          ...
          <div>
            ...
            <button className="w-full flex justify-between items-center border border-gray-200 px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
              <span className="flex items-center gap-2">
                <div className="w-5 h-5 bg-blue-600 rounded-full text-white flex items-center justify-center text-[10px]">TU</div>
                Tu (Soporte N2)
              </span>
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center font-bold">AL</div>
          <div>
            <p className="text-sm font-bold text-gray-800">Ana Lopez</p>
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Contexto Tecnico</h3>
        <div className="space-y-3">
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm mb-1">
              <span className="text-gray-600">Tiempo de Resolucion</span>
